<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestWiseReport.aspx.cs" Inherits="BillManagementForDiagnosticCenterWebApp.UI.TestWiseReport" %>
        ...
        <div class="content">
            <form id="form1" runat="server">
                <div>
                    ...
                    <asp:GridView ID="ShowTestWiseReportGridView" runat="server" AutoGenerateColumns="False" Width="450px" Style="margin-left: 5px">
                        <Columns>
                    ...
                    <table>
                        <tr>
                            <td>
                                <asp:Button ID="pdfButton" runat="server" Text="PDF" Width="70px" OnClick="pdfButton_Click" />
                            </td>
